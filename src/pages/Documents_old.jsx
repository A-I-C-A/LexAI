...
const Documents = () => {
  ...
  const DocumentCard = ({ document }) => {
    ...
    return (
      <div className="bg-gray-50 dark:bg-[#0E0E0E] rounded-2xl p-5 ring-1 ring-white/5 shadow-lg hover:ring-[#ffffff]/20 transition-all duration-300">
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-start space-x-3">
            <div className="text-2xl mt-1">{getFileIcon(document.fileType)}</div>
            <div className="flex-1">
              <h3 className="font-semibold text-gray-900 dark:text-white text-lg mb-1">{document.name}</h3>
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          <span className="bg-gray-50 dark:bg-[#0E0E0E] text-[#ffffff] px-2 py-1 rounded-lg text-xs">
            {document.type}
          </span>
          <span className="bg-gray-50 dark:bg-[#0E0E0E] text-[#a0a0a0] px-2 py-1 rounded-lg text-xs">
        ...
        <div className="flex flex-wrap gap-1 mb-4">
          {document.tags && document.tags.map((tag, index) => (
            <span key={index} className="bg-[#ffffff]/10 text-[#ffffff] px-2 py-1 rounded-md text-xs">
              {tag}
            </span>
          ))}
        </div>
        {document.description && (
          <div className="mb-2 text-[#e0e0e0] text-xs">
            <span className="font-semibold text-[#ffffff]">Description: </span>{document.description}
          </div>
        )}
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-2">
            ...
            <button className="text-[#a0a0a0] hover:text-[#ffffff] transition-colors" title="Download">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
              </svg>
            </button>
            <button className="text-[#a0a0a0] hover:text-[#ffffff] transition-colors" title="Share">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {showVersions && (
          <div className="mt-4 p-3 bg-gray-50 dark:bg-[#0E0E0E] rounded-lg ring-1 ring-white/5">
        ...
        {document.parsedContent && (
          <div className="mt-4 p-3 bg-gray-50 dark:bg-[#0E0E0E] rounded-lg ring-1 ring-white/5">
            <h4 className="font-medium text-gray-900 dark:text-white mb-2">Parsed Content</h4>
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#000000] text-gray-900 dark:text-white p-4 sm:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 sm:mb-12 relative">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div>
              <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white relative">
                Document Management
            ...
            <div className="flex gap-3">
              <button 
                className="px-4 py-3 bg-gray-50 dark:bg-[#0E0E0E] hover:bg-[#343535] text-gray-900 dark:text-white font-medium rounded-xl transition-all duration-300 ring-1 ring-white/5 flex items-center"
        ...
        <div className="bg-gray-50 dark:bg-[#0E0E0E] rounded-2xl p-5 sm:p-6 ring-1 ring-white/5 shadow-lg mb-6 sm:mb-8">
          <div className="flex flex-col gap-4">
            <div className="relative">
              ...
              <input 
                type="text" 
                className="bg-gray-50 dark:bg-[#0E0E0E] ring-1 ring-white/5 text-gray-900 dark:text-white text-sm rounded-xl focus:ring-2 focus:ring-[#ffffff] focus:border-transparent block w-full pl-10 p-3 placeholder-[#a0a0a0] transition-all duration-300" 
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <select 
                className="bg-gray-50 dark:bg-[#0E0E0E] ring-1 ring-white/5 text-gray-900 dark:text-white text-sm rounded-xl focus:ring-2 focus:ring-[#ffffff] focus:border-transparent p-3 flex-1 sm:flex-none transition-all duration-300"
                value={filterType}
                onChange={(e) => setFilterType(e.target.value)}
              >
                {documentTypes.map((type) => (
                  <option key={type} value={type} className="bg-gray-50 dark:bg-[#0E0E0E] text-gray-900 dark:text-white">{type}</option>
                ))}
              </select>
              ...
              >
                {statusOptions.map((status) => (
                  <option key={status} value={status} className="bg-gray-50 dark:bg-[#0E0E0E] text-gray-900 dark:text-white">{status}</option>
                ))}
              </select>
              
              <button 
                className="px-4 py-3 bg-[#ffffff] hover:bg-[#ffffff]/90 text-[#1a1a1a] font-medium rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-[#ffffff]/20 flex items-center"
        ...
        {/* Drag and Drop Area */}
        <div 
          className={`bg-[#0E0E0E] rounded-2xl p-8 border-2 border-dashed mb-8 transition-all duration-300 ${
            isDragging ? 'border-[#ffffff] bg-[#ffffff]/10' : 'ring-white/10 hover:ring-[#ffffff]/30'
          }`}
        ...
        >
          <div className="text-center">
            <div className="w-16 h-16 bg-gray-50 dark:bg-[#0E0E0E] rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <button 
              className="px-4 py-2 bg-gray-50 dark:bg-[#0E0E0E] hover:bg-[#343535] text-gray-900 dark:text-white font-medium rounded-lg transition-all duration-300 ring-1 ring-white/5"
              onClick={() => fileInputRef.current?.click()}
            >
              Select Files
            </button>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 sm:gap-8">
          {filteredDocuments.length > 0 ? (
            ...
            <div className="xl:col-span-2 bg-gray-50 dark:bg-[#0E0E0E] rounded-2xl p-8 ring-1 ring-white/5 shadow-lg flex flex-col items-center justify-center text-center">
              <div className="w-20 h-20 bg-gray-50 dark:bg-[#0E0E0E] rounded-full flex items-center justify-center mb-6">
              ...
              <button 
                className="px-4 py-3 bg-[#ffffff] hover:bg-[#ffffff]/90 text-[#1a1a1a] font-medium rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-[#ffffff]/20 flex items-center justify-center"
                onClick={() => fileInputRef.current?.click()}
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
        ...
        {filteredDocuments.length > 0 && (
          <div className="mb-8">
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Parsed Content Preview</h4>
            <div className="space-y-4">
              {filteredDocuments.map((document, idx) => (
                document.parsedContent && (
                  <div key={idx} className="bg-gray-50 dark:bg-[#0E0E0E] rounded-lg p-4 text-[#e0e0e0] max-h-40 overflow-y-auto">
                    <div className="font-bold text-[#ffffff] mb-2">{document.name}</div>
      ...
      {showUploadModal && (
        <div className="fixed inset-0 bg-white dark:bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-50 dark:bg-[#0E0E0E] rounded-2xl p-6 ring-1 ring-white/5 shadow-lg max-w-md w-full">
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Upload Documents</h3>
            
            <div className="mb-4">
              <h4 className="font-medium text-gray-900 dark:text-white mb-2">Selected Files:</h4>
              <div className="space-y-2 max-h-40 overflow-y-auto">
                {selectedFiles.map((file, index) => (
                  <div key={index} className="flex items-center justify-between p-2 bg-gray-50 dark:bg-[#0E0E0E] rounded-lg">
                    <span className="text-sm text-gray-900 dark:text-white truncate flex-1 mr-2">{file.name}</span>
            ...
            {isUploading && (
              <div className="mb-4">
                <div className="w-full bg-gray-50 dark:bg-[#0E0E0E] rounded-full h-2.5">
                  <div 
                    className="bg-[#ffffff] h-2.5 rounded-full transition-all duration-300" 
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button 
                className="px-4 py-2 bg-[#ffffff] hover:bg-[#ffffff]/90 text-[#1a1a1a] font-medium rounded-lg transition-all duration-300"
