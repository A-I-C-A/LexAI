...
const Scenarios = () => {
  ...
  const renderTab = () => {
    switch (activeTab) {
      case 'whatif':
        return (
          <div className="bg-card rounded-2xl p-6 sm:p-8 backdrop-blur-xl border border-border shadow-lg hover:shadow-xl transition-all duration-500 hover:ring-foreground/20 group">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2">Drag and drop elements to build custom scenarios and analyze potential outcomes</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-card backdrop-blur-xl rounded-xl p-5 border border-border hover:border-foreground/20 transition-all duration-300">
                <h3 className="font-medium text-foreground mb-4 flex items-center">
                  <svg className="w-5 h-5 text-foreground mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {['Contract Breach', 'Payment Delay', 'Force Majeure', 'Price Increase', 'Scope Change', 'Termination'].map(item => (
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <span className="text-foreground group-hover:text-foreground transition-colors duration-300 font-medium">{item}</span>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="lg:col-span-2">
                <div 
                  className="bg-card backdrop-blur-xl rounded-xl p-6 ring-2 ring-border ring-dashed min-h-[300px] mb-6 hover:ring-foreground/20 transition-all duration-300"
                ...
                >
                  ...
                  {scenarioElements.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-64 text-muted-foreground text-center px-4">
                      <svg className="w-16 h-16 mb-4 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      ...
                      {scenarioElements.map((element, index) => (
                        <div key={index} className="p-4 bg-muted border border-foreground/30 rounded-lg hover:bg-foreground/15 transition-all duration-300">
                          <div className="flex justify-between items-center">
                            <span className="text-foreground font-medium">{element.content}</span>
                            <button 
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-between">
                  <button 
                    className="bg-card hover:bg-muted text-foreground px-6 py-3 rounded-xl font-medium transition-all duration-300 flex items-center justify-center gap-2"
            ...
            {aiResponse && (
              <div className="mt-8 p-6 bg-card backdrop-blur-xl border border-foreground/20 rounded-2xl">
                ...
                <div className="prose prose-invert max-w-none">
                  <div className="whitespace-pre-line text-foreground leading-relaxed">{aiResponse}</div>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="bg-card rounded-2xl p-6 sm:p-8 backdrop-blur-xl border border-border shadow-lg hover:shadow-xl transition-all duration-500 hover:ring-foreground/20 group">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2">Calculate cost projections and risk-adjusted financial impacts</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-8">
              <div className="bg-card backdrop-blur-xl p-6 rounded-xl border border-border hover:border-foreground/20 transition-all duration-300">
                <h3 className="font-medium text-foreground mb-6 flex items-center">
                  <svg className="w-5 h-5 text-foreground mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="space-y-5">
                  <div>
                    <label htmlFor="initialCost" className="block text-sm font-medium text-foreground mb-2">Initial Cost ($)</label>
                    <input
                      id="initialCost"
                      type="number"
                      className="w-full p-4 rounded-xl bg-card border border-border shadow-lg text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-foreground/50 focus:border-foreground/50 transition-all duration-300"
                  ...
                  <div>
                    <label htmlFor="monthlyCost" className="block text-sm font-medium text-foreground mb-2">Monthly Cost ($)</label>
                    <input
                      id="monthlyCost"
                      type="number"
                      className="w-full p-4 rounded-xl bg-card border border-border shadow-lg text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-foreground/50 focus:border-foreground/50 transition-all duration-300"
                  ...
                  <div>
                    <label htmlFor="duration" className="block text-sm font-medium text-foreground mb-2">Duration (months)</label>
                    <input
                      id="duration"
                      type="number"
                      className="w-full p-4 rounded-xl bg-card border border-border shadow-lg text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-foreground/50 focus:border-foreground/50 transition-all duration-300"
                  ...
                  <div>
                    <label htmlFor="riskFactor" className="block text-sm font-medium text-foreground mb-2">Risk Factor (%)</label>
                    <input
                      id="riskFactor"
                      type="number"
                      className="w-full p-4 rounded-xl bg-card border border-border shadow-lg text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-foreground/50 focus:border-foreground/50 transition-all duration-300"
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="bg-card p-5 rounded-xl border border-border">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-muted-foreground text-sm font-medium">Base Cost</span>
                          <svg className="w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                          </svg>
                        </div>
                        <p className="text-2xl font-bold text-foreground">${parseFloat(financialResult.totalCost).toLocaleString()}</p>
                      </div>
                      
                      <div className="bg-card p-5 rounded-xl border border-border">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-muted-foreground text-sm font-medium">Risk Adjusted</span>
                        ...
                        <p className="text-2xl font-bold text-foreground">${parseFloat(financialResult.riskAdjustedCost).toLocaleString()}</p>
                      </div>
                    </div>
                    
                    <div className="bg-card p-5 rounded-xl border border-border">
                      <div className="flex items-center justify-between mb-4">
                        <span className="text-muted-foreground font-medium">Risk Impact</span>
                        <span className="text-foreground text-2xl font-medium">{financialResult.riskPercentage}%</span>
                      </div>
                    ...
                    <div className="bg-card p-5 rounded-xl border border-border">
                      <h4 className="font-medium text-foreground mb-3 flex items-center">
                        <svg className="w-4 h-4 text-foreground mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        Financial Summary
                      </h4>
                      <p className="text-foreground text-sm leading-relaxed">
                        Additional cost due to risk factors: <span className="text-foreground font-medium">
          ...
          <div className="bg-card rounded-2xl p-6 sm:p-8 backdrop-blur-xl border border-border shadow-lg hover:shadow-xl transition-all duration-500 hover:ring-foreground/20 group">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2">Simulate stakeholder perspectives in contract scenarios</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <button
                      ...
                      className={`w-full p-4 rounded-xl text-left transition-all duration-300 font-medium ${
                        selectedRole === role 
                          ...
                          : 'bg-card text-foreground hover:bg-muted hover:text-foreground border border-border hover:ring-foreground/20'
                      }`}
              ...
              <div className="lg:col-span-2 bg-card backdrop-blur-xl p-6 rounded-xl border border-border hover:border-foreground/20 transition-all duration-300">
                ...
                <textarea
                  className="w-full p-4 rounded-xl bg-card border border-border shadow-lg text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-foreground/50 focus:border-foreground/50 transition-all duration-300 resize-none"
                  rows={4}
                ...
                {aiResponse && (
                  <div className="mt-6 p-5 bg-muted border border-foreground/20 rounded-2xl">
                    ...
                    <div className="whitespace-pre-line text-foreground">{aiResponse}</div>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="bg-card backdrop-blur-xl p-6 rounded-xl border border-border hover:border-foreground/20 transition-all duration-300">
              ...
              <p className="text-muted-foreground mb-4">Compare perspectives across all stakeholders</p>
              <button
                className="bg-card hover:bg-muted text-foreground px-6 py-3 rounded-xl font-medium transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          ...
          <div className="bg-card rounded-2xl p-6 sm:p-8 backdrop-blur-xl border border-border shadow-lg hover:shadow-xl transition-all duration-500 hover:ring-foreground/20 group">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2">Map potential legal remedies and escalation strategies</p>
              </div>
            </div>
              ...
              <button 
                className={`p-6 rounded-xl border-2 transition-all duration-300 text-center ${
                  disputeType === 'contractual' 
                    ...
                    : 'bg-card backdrop-blur-xl text-foreground border-transparent ring-1 ring-border hover:ring-foreground/20 hover:bg-muted'
                }`}
          ...
          <div className="bg-card rounded-2xl p-6 sm:p-8 backdrop-blur-xl border border-border shadow-lg hover:shadow-xl transition-all duration-500 hover:ring-foreground/20 group">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2">Visualize how scenarios unfold over time</p>
              </div>
            </div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-card p-4 rounded-xl border border-border">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-muted-foreground text-sm font-medium">Total Events</span>
                          <svg className="w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                          </svg>
                        </div>
                      ...
                      <div className="bg-card p-4 rounded-xl border border-border">
                        ...
                        <p className="text-2xl font-bold text-foreground">{Math.max(...timelineData.map(item => item.day))} Days</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-card p-4 rounded-xl border border-border">
                      ...
                      <p className="text-foreground text-sm leading-relaxed">
                        The scenario spans <span className="text-foreground font-medium">{Math.max(...timelineData.map(item => item.day))} days</span> with{' '}
                        <span className="text-foreground font-medium">{timelineData.length} key events</span> mapped out.
                      </p>
                    </div>
                  </div>
                ) : (
            ...
            {timelineData.length > 0 ? (
                  ...
                  <div className="border-l-2 border-foreground/20 pl-8 ml-4 py-4 space-y-6">
                    {timelineData.map((item, index) => (
                      <div key={index} className="relative group">
                        ...
                        <div className="bg-card p-5 rounded-xl border border-border shadow-sm hover:ring-foreground/20 hover:shadow-lg hover:shadow-foreground/10 transition-all duration-300">
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
                            <h4 className="font-medium text-foreground text-lg">Day {item.day}</h4>
              ...
              <div className="bg-card backdrop-blur-xl p-8 rounded-xl ring-1 ring-border ring-dashed text-center">
                <svg className="w-16 h-16 mx-auto mb-4 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                </svg>
                <p className="text-muted-foreground text-lg font-medium mb-2">Enter a scenario to generate a timeline</p>
                <p className="text-muted-foreground text-sm">AI will create a detailed timeline with key milestones</p>
              </div>
            )}
          ...
          <div className="bg-card rounded-2xl p-6 sm:p-8 backdrop-blur-xl border border-border shadow-lg hover:shadow-xl transition-all duration-500 hover:ring-foreground/20 group">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2">Estimate the likelihood of different scenarios</p>
              </div>
            </div>
              ...
              <div className="bg-card backdrop-blur-xl p-6 rounded-xl border border-border hover:border-foreground/20 transition-all duration-300">
                ...
                {aiResponse ? (
                  <div className="space-y-4">
                    <div className="bg-card p-4 rounded-xl border border-border">
                      <div className="prose prose-invert max-w-none">
                        <div className="whitespace-pre-line text-foreground leading-relaxed text-sm">{aiResponse}</div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-muted to-[#ffffff]/5 p-4 rounded-xl border border-foreground/20">
                      ...
                      <button
                        className="bg-muted hover:bg-muted/80 text-foreground px-4 py-2 rounded-xl font-medium transition-all duration-300 text-sm hover:shadow-lg hover:shadow-foreground/10"
            ...
            <div className="bg-card backdrop-blur-xl p-6 rounded-xl border border-border hover:border-foreground/20 transition-all duration-300">
              ...
              <p className="text-muted-foreground mb-4">Run advanced probability simulations with statistical modeling</p>
              
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  className="flex-1 bg-gradient-to-r from-muted to-foreground/10 hover:from-muted/90 hover:to-foreground/20 text-foreground px-6 py-3 rounded-xl font-medium transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                ...
                <button
                  className="flex-1 bg-card hover:bg-card/90 text-foreground px-6 py-3 rounded-xl font-medium transition-all duration-300 border border-border hover:ring-foreground/20 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="mb-8 sm:mb-12 relative">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 relative">
            <div>
              <h1 className="text-3xl sm:text-4xl font-bold text-foreground relative leading-tight">
                Scenario Simulation Agent
                <div className="w-20 h-1 bg-foreground mt-3 rounded-full"></div>
              </h1>
              <p className="text-muted-foreground mt-3 text-base sm:text-lg">AI-powered scenario modeling for contract analysis</p>
            </div>
            ...
            <button
              ...
              className={`
                ...
                ${activeTab === tab.key 
                  ...
                  : 'bg-transparent text-muted-foreground hover:text-foreground hover:bg-card hover:border-foreground/20'
                }
              `}
              onClick={() => { 
