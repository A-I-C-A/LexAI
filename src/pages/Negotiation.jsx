...
const Negotiation = () => {
  ...
  const renderTab = () => {
    switch (activeTab) {
      case 'counter':
        return (
          <div className="bg-card rounded-2xl p-6 backdrop-blur-xl border border-border shadow-lg transition-colors duration-300 hover:shadow-foreground/10">
            ...
            <p className="text-muted-foreground mb-4">Paste a contract clause to generate AI-powered counter-proposals</p>
            <textarea
              className="w-full p-3 rounded-xl bg-background border border-border text-foreground focus:outline-none focus:ring-2 focus:ring-dark-primary mb-4 transition-colors duration-300"
              rows={5}
      ...
      case 'playbook':
        return (
          <div className="bg-card rounded-2xl p-6 backdrop-blur-xl border border-border shadow-lg transition-colors duration-300 hover:shadow-foreground/10">
            ...
            <p className="text-muted-foreground mb-4">Template responses and talking points for common negotiation scenarios</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="bg-background p-4 rounded-xl border border-border transition-colors duration-300 hover:ring-dark-primary/20">
            ...
            <div className="bg-muted p-4 rounded-xl border border-foreground/20">
              <h3 className="font-medium text-dark-primary mb-2">Need a custom response?</h3>
              <textarea
                className="w-full p-3 rounded-xl bg-background border border-border text-foreground mb-3 focus:outline-none focus:ring-2 focus:ring-dark-primary transition-colors duration-300"
                rows={3}
      ...
      case 'email':
        return (
          <div className="bg-card rounded-2xl p-5 sm:p-6 backdrop-blur-xl border border-border shadow-lg">
            ...
            <p className="text-muted-foreground mb-4">Generate professional negotiation emails</p>
            ...
            <textarea
              className="w-full p-3 rounded-xl bg-background border border-border text-foreground mb-4 focus:outline-none focus:ring-2 focus:ring-dark-primary transition-colors duration-300"
              rows={5}
            ...
            <div className="flex gap-3">
              ...
              <button
                className="bg-background text-dark-primary border border-foreground px-6 py-3 rounded-xl font-medium hover:bg-foreground/10 transition-colors duration-300 transform hover:-translate-y-0.5"
            ...
            {aiResponse && (
              <div className="mt-6 p-4 bg-background border border-foreground/20 rounded-xl animate-fadeIn">
                ...
                <div className="mt-4 flex justify-end">
                  <button 
                    className="bg-muted text-dark-primary px-4 py-2 rounded-xl text-sm font-medium hover:bg-foreground/30 transition-colors duration-300 flex items-center"
      ...
      case 'power':
        return (
          <div className="bg-card rounded-2xl p-6 backdrop-blur-xl border border-border shadow-lg transition-colors duration-300 hover:shadow-foreground/10">
            ...
            <p className="text-muted-foreground mb-4">Analyze the balance of power in your negotiation</p>
            ...
            <button
              className="bg-foreground text-background px-6 py-3 rounded-xl font-medium hover:bg-foreground/90 transition-colors duration-300 mb-6 disabled:opacity-50 disabled:cursor-not-allowed transform hover:-translate-y-0.5"
              ...
              <div className="mt-4 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div className="bg-background p-4 rounded-xl border border-border transition-colors duration-300 hover:ring-dark-primary/20">
                    ...
                    <div className="mb-3">
                      ...
                      <div className="w-full bg-background rounded-full h-2.5">
                        <div 
                          className="bg-foreground h-2.5 rounded-full transition-all duration-1000 ease-out" 
                          style={{ width: `${powerAnalysisResult.ourPosition.strength}%` }}
                        ></div>
                      </div>
                    </div>
                    <p className="text-sm text-muted-foreground">{powerAnalysisResult.ourPosition.reasoning}</p>
                  </div>
                  ...
                  <div className="bg-background p-4 rounded-xl border border-border transition-colors duration-300 hover:ring-dark-primary/20">
                    ...
                    <p className="text-sm text-muted-foreground">{powerAnalysisResult.theirPosition.reasoning}</p>
                  </div>
                </div>
      ...
      case 'winwin':
        return (
          <div className="bg-card rounded-2xl p-6 backdrop-blur-xl border border-border shadow-lg transition-colors duration-300 hover:shadow-foreground/10">
            ...
            <p className="text-muted-foreground mb-4">Find solutions that benefit both parties</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="bg-background p-4 rounded-xl border border-border transition-colors duration-300 hover:ring-dark-primary/20">
                <h3 className="font-medium text-dark-primary mb-2">Our Goals</h3>
                <textarea
                  className="w-full p-2 rounded bg-background backdrop-blur-xl border border-border text-foreground text-sm transition-colors duration-300"
                  rows={3}
      ...
      case 'history':
        return (
          <div className="bg-card rounded-2xl p-5 sm:p-6 backdrop-blur-xl border border-border hover:ring-dark-primary/20 shadow-lg hover:shadow-xl transition-colors duration-500 group h-full flex flex-col">
            <h2 className="text-xl sm:text-2xl font-medium mb-4 text-dark-primary flex items-center">
              <span className="mr-2 text-2xl">🕑</span> Negotiation History
            </h2>
            <p className="text-muted-foreground mb-6">Review past negotiations and their outcomes</p>
            
            {negotiationHistory.length > 0 ? (
              <div className="space-y-4">
                {negotiationHistory.map(item => (
                  <div key={item.id} className="bg-background p-4 rounded-xl border border-border hover:ring-dark-primary/20 transition-colors duration-300 transform hover:-translate-y-1">
                    ...
                    <button className="mt-3 text-dark-primary/80 hover:text-dark-primary text-sm font-medium transition-colors duration-300">
                      View Details →
                    </button>
                  </div>
                ))}
              ...
              <div className="bg-background p-8 rounded-xl ring-1 ring-border ring-dashed text-center">
                <p className="text-muted-foreground">No negotiation history yet</p>
                <p className="text-muted-foreground text-sm mt-2">Your negotiation analyses will appear here</p>
              </div>
            )}
            ...
            <div className="mt-6 pt-4 border-t border-border">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-background p-3 rounded-xl text-center transition-colors duration-300 hover:ring-dark-primary/20 border border-border">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap gap-2 mb-8" ref={tabRef}>
          {TABS.map(tab => (
            <button
              key={tab.key}
              className={`px-4 py-2 rounded-xl font-medium transition-colors duration-300 flex items-center ${
                activeTab === tab.key 
                  ? 'bg-card text-dark-primary border-2 border-foreground shadow-lg shadow-foreground/20' 
                  : 'bg-card backdrop-blur-xl text-muted-foreground ring-2 ring-border hover:text-dark-primary hover:ring-dark-primary/20'
