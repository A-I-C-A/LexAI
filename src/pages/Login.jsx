          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="animate-fade-in-up" style={{animationDelay: '0.3s'}}>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-muted ring-1 ring-border rounded-lg text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-landing-accent focus:border-transparent transition-all duration-200"
