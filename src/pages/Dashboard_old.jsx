...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 min-h-screen bg-white dark:bg-[#000000] text-gray-900 dark:text-white p-4 sm:p-6">
      {/* Header Section */}
      ...
      <div className="mt-6 sm:mt-8 grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
        <div className="bg-gray-50 dark:bg-[#0E0E0E] rounded-2xl p-5 sm:p-6 ring-1 ring-white/5 hover:ring-[#ffffff]/20 shadow-lg hover:shadow-xl transition-all duration-500 group h-full flex flex-col">
          <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white transition-all duration-500 leading-tight break-words mb-4 sm:mb-6 flex items-center">
            <div className="w-2 h-4 sm:h-6 bg-[#ffffff] rounded-full mr-3"></div>
            Recent Activity
          </h3>
              ...
              <div key={index} className="flex items-start pb-3 sm:pb-4 border-b border-textcolor/10 last:border-0 group">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1 sm:gap-2">
                    <p className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white group-hover:text-[#A9CEF4] transition-colors duration-300 min-w-0">
                      {deadline.title}
                    </p>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400 mt-0.5 truncate">{deadline.description}</p>
                </div>
              </div>
            ))}
          </div>
